...
<form action="#" method="post" name="form1">
 <table  width="100%" border="1" cellspacing="1" cellpadding="5" style="border:#DFDFDF 1px solid; padding:25px 12px 15px 12px; background:#FDFDFD; ">
				...
				<tr><td width="40%" align="center" style= "border:#E1E1E1 1px solid;">※客户Logo:</td><td  align="left" style= "border:#E1E1E1 1px solid;"><input type="file" size="50" name="custom_logo_path"  id="custom_logo_path" onchange="uplogo()"><input  type="hidden" name="filename" id="filename"></td></tr>
				<tr width="100%">
